...
- It's not very user-friendly, especially since hacking the terminal input means all the terminal's native text-editing features are gone.
  - To somewhat make up for this and the visual blandness, I'm adding colors and backspacing (to delete input), which you can see in [the GitHub repo](https://github.com/fpsvogel/worlds-terminal). (See [the 0.1.0 release](https://github.com/fpsvogel/worlds-terminal/tree/v0.1.0) if you want to see just the features related to this post.)
