...
What I mean is that it's common to admire developers who skipped being a junior and figured everything out "in the real world." Some people take this admiration so far that they discount junior roles entirely. Once I was told that I'm "projecting a position of weakness" by saying that I'm looking for a junior role. This same person urged me to build a product and start my own company so that maybe in a year *I'll* be the boss hiring people.

(￣(エ)￣)ゞ

Let's set aside the facts that I don't want to start my own company, I do try to convey competence and not helplessness to potential employers, and I don't need *and am not looking for* extra hand-holding on every little thing—I am happily self-taught, so I'm obviously comfortable working independently.

Those facts aside, here's why I applied to junior roles almost exclusively:

- **Because that's how I think I'll grow the most.** In my previous career I was a teacher, so I appreciate the power of learning by example. As a new developer, I'll learn most quickly and most thoroughly if I'm working with experienced developers who exemplify best practices. I could probably (painfully) learn all the same things on my own over time, but it would take much longer. So I don't believe I'm holding myself back by going for a junior role—quite the opposite.
- **Because I don't have time to apply to everything.** During the job hunt I was already working a full-time job in order to pay the bills. Also, I spent most of my free time filling in the gaps on my resume; I felt that was a better use of time than filling out dozens of long-shot applications for mid-level positions. Even the few applications that I did undergo were time-consuming in themeselves, due to their usually long process of multiple interviews plus a take-home programming exercise. So I wanted to maximize my chances of getting a job by applying to my top (and most realistic) choices while continually improving my resume. This approach was also a lot more enjoyable than making job applications my new default evening activity.
...
*What about LinkedIn?* Yes, be sure to have a LinkedIn profile. But I found very few junior roles on LinkedIn, and none that I applied for. Some other sites that might be worth checking just in case: [Indeed](https://www.indeed.com/), [AngelList](https://angel.co/), [Hired](https://hired.com), [RailsGigs](https://www.railsgigs.com/), and the [GoRails job board](https://jobs.gorails.com/). If you live outside the U.S., be sure to look in local job boards if there are any in your area. (If you're not sure, try asking in [Ruby on Rails Link](https://www.rubyonrails.link/).)
...
Speaking of salaries, there's a huge range in what people think a junior's salary should be. Among the full-time junior job postings I came across, not counting internships, the range in advertised salaries was $40k/year to $120k/year.
...
- **Keep a study guide.** I got compliments on [my study guide](https://github.com/fpsvogel/learn-ruby-and-cs) in two interviews, but it's another one of those things that's useful to do even if no one notices, especially if you're self-taught.
...
- **Make a web version of your resume.** Here's mine: [fpsvogel.com/about](https://fpsvogel.com/about/). This is in addition to (not instead of) the PDF version that I submitted in applications. [Here's my resume in PDF](https://www.overleaf.com/read/mgxfqgqngjqf) as of January 2022. I made it with LaTeX because I happened to know it already; otherwise I would've written it in a plain old word processor. Remember, keep it under one page!

## What to ask in the initial interview

Once your resume is polished up, you're more likely to be invited to an interview. Asking good questions in the initial interview is just as important as giving good answers—after all, you are interviewing the company as much as they are interviewing you. Your goal, besides making a good impression, is to find out whether that company would be a good fit for you. Here are the questions I asked in my initial interviews, along with my motivation for asking some of them.
...
- **"How often do your developers have to work odd hours or take care of unexpected issues?"**
  - Some companies require their developers to be on call during off hours. I wanted to avoid that as much as possible.
...
If you're wondering how to build up these skills, take a look at [the Ruby and Rails review reading list](https://fpsvogel.com/posts/2021/review-ruby-and-rails-for-job-interview) which I've recently being working through. [My ongoing study guide](https://github.com/fpsvogel/learn-ruby-and-cs) has a fuller list of resources.
