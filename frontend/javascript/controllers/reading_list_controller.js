...
export default class extends Controller {
  ...
  expandOrCollapse(event) {
    ...
    // let collapsedBlurbClicked = item.classList.contains("collapsed") && clickedTag == "RL-BLURB"
    let nameClicked = clickedTag == "A"
    let notesClicked = clickedTag == "P"
    // let blurbClicked = clickedTag == "RL-BLURB"
    // if (collapsedBlurbClicked || (!nameClicked && !notesClicked && !blurbClicked)) {
